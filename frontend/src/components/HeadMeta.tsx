...
export const siteName = 'metabuzz.io'
export const mainTitle = `Metabuzz | NFT social metaverse.`
const siteUrl = window.location.hostname == 'localhost' ? '' : `https://${siteName}`
// tslint:disable-next-line:max-line-length
const mainDescription = `Own, Play, Grow, and Earn.`
...
const support_email = 'support@metabuzz.io'
    ...
    <>
      <Helmet
        ...
        meta={[
          ...
          { property: 'og:logo', content: '//metabuzz.io/meta/logo-icon.png',     size: '256x234' },
          { property: 'og:logo', content: '//metabuzz.io/meta/favicon-32x32.png', size: '32x32'   },
          { property: 'og:logo', content: '//metabuzz.io/meta/favicon-16x16.png', size: '16x16'   },
