...
import { c, getPropColor, themes } from 'styles'
import { Box, BoxProps, s } from 'styles-global'
...
}))<{ selectable?: boolean, disabled?: boolean, iconOp?: number, hoverOp?: number, isActive?: boolean }>`
  ${p => !p.selectable && s.unselectable} ${s.anchor}
