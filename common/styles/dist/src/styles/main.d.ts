...
export declare const Divider: import("styled-components").StyledComponent<"div", any, {
    ...
    sz?: (string | number) & (string | number | string[] | number[]);
    verticalAlign?: string | string[];
    fontSize?: (string | number) & (string | number | string[] | number[]);
