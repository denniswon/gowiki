...
export declare const IconWithStyles: import("styled-components").StyledComponent<({ tag, children, ...props }: {
    [x: string]: any;
    tag: any;
    children: any;
}) => React.DetailedReactHTMLElement<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>, any, {
    center?: boolean;
} & {
