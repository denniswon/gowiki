...
exports.systemBox = exports.layout = exports.typography = exports.spacing = exports.defaultBreakpoints = void 0;
// based on styled-system 4.1.1
exports.defaultBreakpoints = [40, 52, 64].map(n => n + 'em');
...
const themeGet = (path, fallback = null) => props => get(props.theme, path, fallback);
...
const style = ({ prop, cssProperty, alias, key, transformValue = getValue, scale: defaultScale = {}, }) => {
    ...
    const func = props => {
        ...
        const breakpoints = get(props.theme, 'breakpoints', exports.defaultBreakpoints);
        const styles = [];
...
exports.spacing = mapProps(props => ({
    ...props,
...
}))(compose(margin, marginTop, marginBottom, marginLeft, marginRight, padding, paddingTop, paddingBottom, paddingLeft, paddingRight));
// typography
...
exports.typography = compose(fontSize, fontFamily, fontWeight, lineHeight, fontStyle, letterSpacing);
// layout
const display = style({
    prop: 'display',
});
...
exports.layout = compose(display, width, maxWidth, minWidth, height, maxHeight, minHeight, size, verticalAlign);
// flexbox
...
const flex = compose(order, flexWrap, flexShrink, flexBasis, flexDirection, alignSelf);
// grid
// const gridGap = style({
//   prop: 'gridGap',
//   key: 'space',
...
const borders = compose(border, borderTop, borderRight, borderBottom, borderLeft, borderWidth, borderStyle, borderColor, borderRadius);
...
const appearance = compose(borders, backgroundColor, textColor, boxShadow, opacity, overflow, background, backgroundImage, backgroundSize, backgroundPosition, backgroundRepeat);
// position
...
const positionProps = compose(position, zIndex, top, right, bottom, left);
exports.systemBox = compose(exports.layout, exports.typography, exports.spacing, appearance, positionProps, flex);
//# sourceMappingURL=styledSystems.js.map