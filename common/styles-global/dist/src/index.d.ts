...
} & types.QuickTypographyProps & types.QuickFlexProps & types.QuickPositionProps & types.MediaProps, "col">;
export declare const Row: import("styled-components").StyledComponent<"div", any, {
    ...
    flexDirection?: string | string[];
    alignSelf?: string | string[];
} & types.QuickTypographyProps & types.QuickFlexProps & types.QuickPositionProps & types.MediaProps, "row">;
export declare const Box: import("styled-components").StyledComponent<"div", any, {
    ...
    flexDirection?: string | string[];
    alignSelf?: string | string[];
} & types.QuickTypographyProps & types.QuickFlexProps & types.QuickPositionProps & types.MediaProps, never>;
