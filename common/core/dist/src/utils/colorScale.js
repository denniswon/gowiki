...
exports.getHash = exports.getUniqueColorObjectForId = exports.COLOR_SCALE = exports.COLOR_SCALE_BASE = void 0;
const savedIdsToColorIndex = {};
exports.COLOR_SCALE_BASE = [
    '#A3C7FE',
    '#B7ABFC',
    '#FEB7FF',
    '#FFA1A1',
...
const getIndexesForColorScale = () => Array.from(Array(exports.COLOR_SCALE_BASE.length).keys());
let unusedColorsByIndex = getIndexesForColorScale();
function getUniqueColorObjectForId(id = '') {
    // use keyd colors based on id for quick and safe retreival
    if (savedIdsToColorIndex[id] != null) {
        return exports.COLOR_SCALE[savedIdsToColorIndex[id]];
    }
    ...
    const colorIndex = unusedColorsByIndex[exports.getHash(id) % unusedColorsByIndex.length];
    unusedColorsByIndex.splice(unusedColorsByIndex.indexOf(colorIndex), 1);
    savedIdsToColorIndex[id] = colorIndex;
    return exports.COLOR_SCALE[colorIndex];
}
exports.getUniqueColorObjectForId = getUniqueColorObjectForId;
function hashCode(s = '') {
...
const getHash = (str) => Math.abs(hashCode(str));
